    ...
    def init(self, id, month):
        ...
        if month != 8:
            ...
            if recent_program_name == "":
                ...
                most_program_num = str(user_data["most_sooni_program_num"][id])
                entire_program_num = user_data["entire_sooni_program_num"][id]

                msg2 += "\n\n가장 많이 하셨던 활동은 " + most_program_name + "이에요!\n"
                msg2 += most_program_name + "를 이번 한 달 동안 " + most_program_num + "번 하셨어요! 재미있게 하셨던 것 같나요?\n\n"
                if entire_program_num > 20:
                    msg2 += "순이와 활동을 정말 많이 하신 것 같아요!\n이번 달 동안 활동을 전체" + str(entire_program_num) + "번 했답니다!\n"
                    msg2 += "순이도 함께 한 활동들이 즐거웠어요. 앞으로도 잘 부탁드려요!\n"
                elif entire_program_num > 10:
                    msg2 += "순이와 활동을 많이 했어요!\n이번 달 동안 활동을 전체" + str(entire_program_num) + "번 했답니다!\n"
                    msg2 += "순이와 함께 할 수 있는 활동들이 생각보다 많이 준비되어 있어요! 새 활동에 도전해 보는 것은 어떤가요?\n"
                elif entire_program_num > 1:
                    msg2 += "순이와 활동을 하는 재미를 점점 느끼고 계신가요?\n이번 달 동안 활동을 전체" + str(entire_program_num) + "번 했답니다!\n"
                    msg2 += "순이는 앞으로도 많은 활동을 함께 할 것 같아서 설레요!\n"
                else:
                    msg2 += "앗 순이와 활동을 한 번도 진행해 보지 않았어요!\n 함께 할 수 있는 활동들이 많이 준비되어 있어요.\n"
                    msg2 += "순이와 함께 영화 보는 시간을 가져 보는 것은 어떠신가요? 무비순이 활동을 추천드려요!"
